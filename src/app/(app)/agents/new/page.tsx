...
export default async function NewAgentPage() {
  ...
  const [channels, knowledgeSources] = await Promise.all([
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <AgentForm channels={channels} knowledgeSources={knowledgeSources} action={createAgent} submitLabel="Crear agente" />
    </div>
  );
}

import { LayoutDashboard, Inbox, Bot, BookOpen, Radio, Plug, Package, Users, BarChart3, Gauge, Settings, ShieldCheck, CalendarDays } from "lucide-react";
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/agenda", label: "Agenda", icon: CalendarDays, roles: ["SUPER_ADMIN", "COMPANY_ADMIN"] },

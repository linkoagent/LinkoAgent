const cases = [
  { title: "Tiendas online", body: "Recupera carritos abandonados y responde consultas de stock en segundos." },
  { title: "Restaurantes", body: "Toma reservas y pedidos sin dejar sonando el teléfono en hora pico." },
  { title: "Clínicas", body: "Agenda turnos y envía recordatorios que bajan el ausentismo." },
  { title: "Estéticas", body: "Confirma turnos y promociona servicios sin ocupar a la recepción." },
  { title: "Inmobiliarias", body: "Califica interesados y agenda visitas antes de que se enfríen." },
  { title: "Educación", body: "Responde consultas de inscripción a toda hora, en temporada alta." },
  { title: "Gimnasios", body: "Gestiona altas, planes y recordatorios de vencimiento de cuota." },
  { title: "Servicios profesionales", body: "Filtra y agenda consultas antes de que lleguen a tu agenda." },
  { title: "Indumentaria", body: "Responde talles y stock al instante en Instagram, donde vende de verdad." },
